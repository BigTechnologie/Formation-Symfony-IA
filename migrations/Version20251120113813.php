 ...
 */
final class Version20251120113813 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE livre CHANGE user_id user_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE livre CHANGE user_id user_id INT NOT NULL');
    }
}
